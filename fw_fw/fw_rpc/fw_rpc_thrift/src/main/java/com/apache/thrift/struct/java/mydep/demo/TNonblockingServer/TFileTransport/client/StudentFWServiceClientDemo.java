package com.apache.thrift.struct.java.mydep.demo.TNonblockingServer.TFileTransport.client;
...
public class StudentFWServiceClientDemo {
  ...
  public void startClient(String userName) {
    ...
    try {
      try {
        transport = new TFramedTransport(new TFileTransport("e:/123.txt", true));
      } catch (IOException e) {
        e.printStackTrace();
      }
