...
public class Consumer {
    ...
    public static void main(String[] args) throws InterruptedException, MQClientException {
        ...
        consumer.setNamesrvAddr(RockmqProps.nameServers);
        ...
        consumer.setPullThresholdForQueue(10);consumer.setPullThresholdForTopic(5);
        consumer.setPullThresholdSizeForTopic(10);
        consumer.setSuspendCurrentQueueTimeMillis(10);
        consumer.setHeartbeatBrokerInterval(10);
